...
-- CreateIndex
CREATE UNIQUE INDEX "qr_codes_itemId_key" ON "qr_codes"("itemId");
...
-- AddForeignKey
ALTER TABLE "qr_codes" ADD CONSTRAINT "qr_codes_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "items"("id") ON DELETE CASCADE ON UPDATE CASCADE;
